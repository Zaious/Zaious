...
| **[riftbound-chronicle](https://github.com/Zaious/riftbound-chronicle)** | Claude Code skill for the Riftbound TCG: deck-building, rules consultation, and a "Player 2" decision agent for physical practice. | ![stars](https://img.shields.io/github/stars/Zaious/riftbound-chronicle?style=flat) |
