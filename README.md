...
| **[riftbound-chronicle](https://github.com/Zaious/riftbound-chronicle)** | Preparation-phase AI for the Riftbound TCG — deck coach, cited rules consult, and a human-confirmed Player 2 agent — on a sovereign rules core that fails closed on anything it can't model. Not a simulator, not a judge. | ![stars](https://img.shields.io/github/stars/Zaious/riftbound-chronicle?style=flat) |
